    ...
    <div id="sub_content">
        <form th:action="@{/Updateuser}" method="Post" th:object="${User}">
            ...
            <h3 style="color:red;" align="center" th:text="${error}"></h3>
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" id="email" readonly="readonly" th:field="*{id}"/>
                </div>
                <div class="col-md-4">
                <label
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                   <input type="password" class="form-control" id="name" name="password" th:value="${User.password}"/>
                </div>
                <div class="col-md-4">
                <label
