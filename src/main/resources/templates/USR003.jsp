...
<body>
    ...
    <div id="sub_content">
        <form class="row g-3 mt-3 ms-2" th:action="@{/setupsearchuser}" th:object="${search}" method="Post">
            <div class="col-auto">
                <label for="staticEmail2" class="visually-hidden">User Id</label>
                <input type="text" class="form-control" th:field="*{id}" id="staticEmail2" placeholder="User ID"/>
            </div>
            <div class="col-auto">
                <label for="inputPassword2" class="visually-hidden">User Name</label>
                <input type="text" class="form-control" th:field="*{username}" id="inputPassword2" placeholder="User Name"/>
            </div>
            ...
            <div class="col-auto">
            <button type="button" class="btn btn-secondary " onclick="location.href = '/adduserview';">
                    Add
                </button>
                </div>
            </form>
        <table class="table table-striped" id="stduentTable">
            ...
            <tbody>
                ...
                <td>
                <a th:href="@{/setupupdateuser(id=${u.id})}">
                    <button type="submit" class="btn btn-success" data-bs-toggle="modal">
                        Update
                    </button></a>
                </td>
                <td>
                <a th:href="@{/setupdeleteuser(id=${u.id})}">
