...
<body>
        ...
        <form th:action="@{/CreateUser}" method="Post" th:object="${UserBean}">

            <h2 class="col-md-6 offset-md-2 mb-5 mt-4">Create Account</h2>
            <div class="row mb-4">
            <h3 style="color:red;" align="center" th:text="${error}"></h3>
                <div class="col-md-2"></div>
                <label for="email" class="col-md-2 col-form-label">User ID</label>
                <div class="col-md-4">
                    <input type="text" class="form-control" id="email" th:field="*{id}"/>
                </div>
                <div class="col-md-4">
                <label

				th:if="${#fields.hasErrors('id')}"
				th:errors="*{id}" style="color:red;">Error</label>
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
				...
				th:errors="*{username}" style="color:red;">Error</label>
                </div>
            </div>
			...
			th:errors="*{useremail}" style="color:red;">Error</label>
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
                ...
                <div class="col-md-4">
                   <input type="password" class="form-control" id="name" name="password" th:value="${UserBean.password}"/>
                </div>
                <div class="col-md-4">
                <label

				th:if="${#fields.hasErrors('password')}"
				th:errors="*{password}" style="color:red;">Error</label>
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
                ...
                <div class="col-md-4">
                    <input type="password"   class="form-control" id="confirmPassword" name="confirm_password" th:value="${UserBean.confirm_password}"/>
                </div>
                <div class="col-md-4">
                <label

				th:if="${#fields.hasErrors('confirm_password')}"
				th:errors="*{confirm_password}" style="color:red;">Error</label>
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
                ...
                <div class="col-md-4">
                    <select class="form-select" aria-label="Education" id="userRole" th:field="*{role}">
                        <option th:value="'Admin'" th:text="Admin">Admin</option>
                        <option th:value="'User'" th:text="User">User</option>
                    ...
                    <div class="col-md-4">
                     <label
						...
						th:errors="*{role}" style="color:red;">Error</label>
                </div>
                </div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <button type="button" class="btn btn-secondary col-md-2 " onclick="location.href = '/';">
                Back
            </button>
